...
(async () => {
    ...
    await generateMapObjects(OUTPUT_SVG_TYPES_FILE);
})();
...
async function generateMapObjects(outputSVGTypesFile: string): Promise<void> {
    ...
    const tsFileContent = `// file auto-generated by scripts/process-svg.ts
...
${generateObject("EmailSVGArrowCSSClass", arrowClasses)}
${generateObject("EmailSVGStateBoxCSSClass", stateBoxClasses)}
`;
    const prettierOptions = await prettier.resolveConfig(process.cwd());
